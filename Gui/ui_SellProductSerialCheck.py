...
"border-radius: 20px;")
        ...
        self.IMEIList = QtWidgets.QListWidget(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.IMEIList.setFont(font)
        self.IMEIList.setObjectName("IMEIList")
        self.verticalLayout.addWidget(self.IMEIList)
...
"background-color: rgb(0, 117, 14);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ProductLabel.setText(_translate("MainWindow", "Error"))
